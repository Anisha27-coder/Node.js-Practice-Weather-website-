...
return null},$c=!1;if(H.querySelectorAll)try{var ad=H.querySelectorAll(":root");ad&&1==ad.length&&ad[0]==H.documentElement&&($c=!0)}catch(a){}var Xc=$c;var od={},K=null,pd=Math.random();od.s="GTM-NXKGDP";od.Pb="7v1";od.Pd="";var qd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},ud="www.googletagmanager.com/gtm.js";
var vd=ud,wd=null,xd=null,yd="//www.googletagmanager.com/a?id="+od.s+"&cv=61",zd={},Ad={},Bd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
Z.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=zk(c,"gtm.click");ml(d)}}(function(b){Z.__cl=b;Z.__cl.b="cl";Z.__cl.g=!0;Z.__cl.priorityOverride=0})(function(b){if(!rl("cl")){var c=W("document");sc(c,"click",a,!0);sl("cl")}I(b.vtp_gtmOnSuccess)})}();
...
Z.a.html=["customScripts"],function(){function a(d,e,f,h){return function(){try{if(0<e.length){var k=e.shift(),l=a(d,e,f,h);if("SCRIPT"==String(k.nodeName).toUpperCase()&&"text/gtmscript"==k.type){var p=H.createElement("script");p.async=!1;p.type="text/javascript";p.id=k.id;p.text=k.text||k.textContent||k.innerHTML||"";k.charset&&(p.charset=k.charset);var m=k.getAttribute("data-gtmsrc");m&&(p.src=m,nc(p,l));d.insertBefore(p,null);m||l()}else if(k.innerHTML&&0<=k.innerHTML.toLowerCase().indexOf("<script")){for(var r=
...
d.vtp_gtmOnFailure,f=vl(d.vtp_html,d.vtp_gtmOnSuccess,e),h=f.Xc,k=f.D;if(d.vtp_useIframe){}else d.vtp_supportDocumentWrite?b(h,k,e):a(H.body,wc(h),k,e)()}else gl(function(){c(d)},
